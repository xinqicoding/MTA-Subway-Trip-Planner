...
def aml_connection():
    """Connects to the service and validates that credentials are
configured properly.
    """
	...
	raise RuntimeError("""There was a problem connecting to Amazon
Machine Learning.
...
class Schema(JsonConfiguration):
    ...
    def set_target(self, target_variable_name):
        ...
        #     raise SchemaException("Can't set target to undefined variable %s" %target_variable$
